function CMA_batch_analysisApr24(datadir,outputfile)


%function [burstT, singT, filesNotWorking] = CMA_batch_analysisFeb17()

% CMA Batch Analysis
%This is the batch-analysis version of CMA_burst_analysis_Nov10.m. Output =
%table with each row corresponding to a different cell, showing their
%average properties. one table for bursts, one for singlets.
...
for n=1:size(file_names,2)
      ...
      try
        [singletAnalysisRow, T] = CMA_burst_analysis_apr24(filename); %get burst and singlet analysis for thsi cell
        burstT = [burstT; T];
