function M1 = analyzeSingleEvokedApr8(filename1, current_injected1)
...
for a= totalsweeps: totalsweeps %analyze the sweep that invokes the first two APs in cell. change this to totalsweeps:totalsweeps to analyze 1st ap of last sweep
