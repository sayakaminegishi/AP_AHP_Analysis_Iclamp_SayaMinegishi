...
filenameExcelDoc = strcat('Evoked_lastSweepWKYN_DEC7.xlsx');

multipleVariablesTable= zeros(0,21);
multipleVariablesRow = zeros(0, 21);
...
for n=1:size(file_names,2)
 ...
 %THRESHOLD SLOPE
   ...
   % manually examine and set the rising and falling
    ...
    %risingDuration = 1185-1059 = 126; 
  %  fallingDuration = 1468-1185 = 283;
    risingDuration = 332;  %originally: 1279-947 = 332
   fallingDuration = 1542-1279; %   263
 ...
 % %%%%%%%%%%%%%FINDING fractions of AP and AHP widths WITH interpolation
   ...
   multipleVariablesRow1= [filename, a, current_injected(a), freq_in_hz, threshold_voltage(1), amplitude(1), AHP_amp(1), minp(1),minpInTrace(1), maxpointdata(1), maxpointInTrace(1), interp_hw_AP_time, AHP_30(1), AHP_50(1), AHP_70(1), AHP_90(1), interp_hw_AHP_time, dec10w(1), dec30w(1), dec70w(1), dec90w(1)];
